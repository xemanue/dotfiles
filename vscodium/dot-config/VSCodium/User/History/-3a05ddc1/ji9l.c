...
/**
* Set CTCs mode with TOP at 24, with 8 clock prescaler.
* Found at <a href="http://ww1.microchip.com/downloads/en/DeviceDoc/Atmel-2549-8-bit-AVR-Microcontroller-ATmega640-1280-1281-2560-2561_datasheet.pdf#page=126">ATmega2560's datasheet</a>
*/
...
/*!
* Go through all the pwm pins vector and compares wheter the number of cycles passed are equal to the max time on of the pwm or the repeat cycle
*/
