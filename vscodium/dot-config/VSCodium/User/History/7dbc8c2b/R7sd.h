 ...
 * @details Sets up the neccesary interrupts for the IO lines (roraty and
 * push-button), as well as the required functions to process such events
 */
...
/**
 * @brief Handles rotary encoder movements on a low level
 * 
 * @return uint8_t Movement made
 */
uint8_t process_rotary();

/**
 * @brief Parses a message received from the serial port
 * 
 * @param[in] rx_buf Message to be parsed
 * @param pwms 
 * @param[out] answer_buf 
 * @return char* TODO
 */
